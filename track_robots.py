...
def get_paths(scriptdir, key, VISUAL=True, log_func=None):
    ...
    while frame_number < end_frame:    
        ...
        for detection in d: #start new paths
            #init_time, last_time, init_cord, last_cord, color, cords
            active_paths.append(Path(frame_number, frame_number, detection.cord, detection.cord, detection.color, { frame_number:detection.cord } ))
    ...
    #     file.write(output)
    # print(f"stopped at frame {frame_number}")
